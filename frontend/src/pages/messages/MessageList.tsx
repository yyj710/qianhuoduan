...
export default function MessageList() {
  ...
  return (
    <div style={{ display: 'flex', height: 'calc(100vh - 180px)' }}>
      {/* Conversation list */}
      <Card title="会话列表" style={{ width: 280, marginRight: 16, overflow: 'auto' }}>
            ...
            renderItem={(conv: any) => (
              ...
              >
                <List.Item.Meta
                  ...
                  description={<Text ellipsis style={{ maxWidth: 160 }}>{conv.lastMessage}</Text>}
                />
              </List.Item>
            )}
          />
      ...
      {/* Chat area */}
      <Card
        title={activePeerName ? `与 ${activePeerName} 的对话` : '选择一个会话'}
